...
import net.elementalcombat.ElementalCombatPlugin.Constants;
import net.elementalcombat.ElementalCombatPlugin.BuildArenaBase;
...
public class TemplateCommandsTests extends BuildArenaBase {
